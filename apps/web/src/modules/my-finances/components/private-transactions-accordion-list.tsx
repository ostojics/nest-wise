...
import {PrivateTransactionContract, TransactionType} from '@maya-vault/contracts';
import {format} from 'date-fns';
import PrivateTransactionRowActions from './private-transaction-row-actions';

interface PrivateTransactionsAccordionListProps {
  data: PrivateTransactionContract[];
}

export default function PrivateTransactionsAccordionList({data}: PrivateTransactionsAccordionListProps) {
            ...
            <AccordionItem key={tx.id} value={String(tx.id)}>
              ...
              <AccordionContent className="px-4 pb-4">
                ...
                <div className="pt-3 flex justify-end">
                  <PrivateTransactionRowActions transactionId={tx.id} />
                </div>
              </AccordionContent>
            </AccordionItem>
          );
