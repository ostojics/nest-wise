...
interface ScheduledTransactionsErrorProps {
  error: Error | null;
}

export default function ScheduledTransactionsError({error}: ScheduledTransactionsErrorProps) {
  return (
      ...
      <div className="flex flex-col items-center justify-center py-12 space-y-4">
        <div className="text-center">
          ...
          <p className="text-sm text-muted-foreground mt-2">
            {error?.message ?? 'Došlo je do greške pri učitavanju zakazanih transakcija.'}
          </p>
        </div>
